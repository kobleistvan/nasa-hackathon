...
gulp.task('browserify', function() {
    var b = browserify();
    b.add('./lib/client/javascripts/app.jsx');
...
gulp.task('default', function() {
    runSequence('cleanJS', 'cleanCSS', 'less', 'browserify');
});

gulp.task('production', function() {
    runSequence('cleanJS', 'cleanCSS', 'less', 'browserify', 'uglify', 'minifycss');
});

gulp.task('cleanAndLess', function() {
    runSequence('cleanCSS', 'less');
});

gulp.task('cleanAndBrowserify', function() {
    runSequence('cleanJS', 'browserify');
});
